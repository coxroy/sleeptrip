...
selectedEvents.start_epoch=ceil(selectedEvents.start/epochlength_events);
selectedEvents.stop_epoch=ceil(selectedEvents.stop/epochlength_events);
...
label_absent=sprintf('%s_absent',selectedEvent);
label_present=sprintf('%s_present',selectedEvent);
