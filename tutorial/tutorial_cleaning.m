...
cfg_artifacts.channelexpandthresh = 0.5; %label a segment's non-artifactual channels as artifact if at least 50% of neighboring channels are artifactual
cfg_artifacts.segmentrejectthresh=0.5; %mark segment for rejection if at least 50% of channels are artifactual
